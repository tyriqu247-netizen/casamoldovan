...
const Navbar1 = (props) => {
  ...
  return (
    <>
      <header
        id={props.navbar1Id}
        className={`navbar1-container1 ${props.rootClassName} `}
      >
        <header data-thq="thq-navbar" className="navbar1-navbar-interactive">
          ...
          <div data-thq="thq-navbar-nav" className="navbar1-desktop-menu">
            <nav className="navbar1-links1">
              <div className="navbar1-container2">
                <div className="navbar1-container3">
                  <div className="navbar1-container4">
                    <div className="navbar1-container5">
                      <a
                        href={props.link1Url}
                        className="navbar1-link11 thq-body-small thq-link"
                      >
                        {props.link1 ?? (
                          <Fragment>
                            <span className="navbar1-text2">
                              <span
                                dangerouslySetInnerHTML={{
                                  __html: translate.raw('text_hlFB_j'),
                                }}
                              ></span>
                            </span>
                          </Fragment>
                      ...
                      <a
                        href={props.link2Url}
                        className="navbar1-link21 thq-body-small thq-link"
                      >
                        {props.link2 ?? (
                          <Fragment>
                            <span className="navbar1-text3">
                              <span
                                dangerouslySetInnerHTML={{
                                  __html: translate.raw('text_t87BcD'),
                                }}
                              ></span>
                            </span>
                          </Fragment>
                      ...
                      <a
                        href={props.link3Url}
                        className="navbar1-link31 thq-body-small thq-link"
                      >
                        {props.link3 ?? (
                          <Fragment>
                            <span className="navbar1-text5">
                              <span
                                dangerouslySetInnerHTML={{
                                  __html: translate.raw('text_UEHBJm'),
                                }}
                              ></span>
                            </span>
                          </Fragment>
                      ...
                      <a
                        href={props.link4Url}
                        className="navbar1-link41 thq-body-small thq-link"
                      >
                        {props.link4 ?? (
                          <Fragment>
                            <span className="navbar1-text6">
                              <span
                                dangerouslySetInnerHTML={{
                                  __html: translate.raw('text_XFMzWP'),
                                }}
                              ></span>
                            </span>
                          </Fragment>
                ...
                <Link href="/">
                  <a className="navbar1-link6 button">
                    <span>
                      {props.button ?? (
                        <Fragment>
                          <span className="navbar1-text4">
                            <span
                              dangerouslySetInnerHTML={{
                                __html: translate.raw('text_HWfSJx'),
                              }}
                            ></span>
                          </span>
                        </Fragment>
            ...
            <div className="navbar1-icon-group1">
              <a
                href="https://www.instagram.com/coltderai2021?igsh=MWZyYzc0Yzl0eWNxOA=="
                target="_blank"
                rel="noreferrer noopener"
                className="navbar1-link7"
              >
                <svg
                  height="32"
                  width="32"
                  viewBox="0 0 32 32"
                  className="navbar1-icon10"
                >
                  <circle
                    cx="22.406"
                    cy="9.594"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="navbar1-link8"
              >
                <svg
                  height="32"
                  width="32"
                  viewBox="0 0 32 32"
                  className="navbar1-icon14"
                >
                  <path
                    fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="navbar1-link9"
              >
                <svg
                  height="24"
                  width="24"
                  viewBox="0 0 24 24"
                  className="navbar1-icon16"
                >
                  <path
                    fill="currentColor"
          ...
          <div data-thq="thq-mobile-menu" className="navbar1-mobile-menu">
            <div className="navbar1-nav">
              <div className="navbar1-top">
                ...
                <div data-thq="thq-close-menu" className="navbar1-close-menu">
                  <svg viewBox="0 0 1024 1024" className="navbar1-icon20">
              ...
              <nav className="navbar1-links2">
                ...
                <a href={props.link5Url} className="thq-body-small thq-link">
                  {props.link5 ?? (
                    <Fragment>
                      <span className="navbar1-text7">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_RpLLxm'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
            ...
            <div className="navbar1-icon-group2">
              <svg
